...
public class ConfigEvents {
    ...
    public static final Event<RegisterTypeAdapter> REGISTER_CONFIG_TYPE_ADAPTERS = EventFactory.createEventResult();
    public static final Event<RegisterConfigManager> REGISTER_CONFIG_MANAGERS = EventFactory.createEventResult();

    public interface RegisterEvent{
        EventResult post(ConfigRegisterEvent event);
    }
    public interface RegisterTypeAdapter{
        EventResult post(GetConfigTypeAdaptersEvent event);
    }
